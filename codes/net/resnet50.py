        ...
        with slim.arg_scope([slim.conv2d, bottleneck,
          ...
          with slim.arg_scope([slim.batch_norm], is_training=is_training):
            ...
            if num_classes:
              ...
              end_points['fc_weights'] = [var for var in tf.global_variables() if var.op.name=='resnet_v2_50/logits/weights'][0]
            ...
            return activation, end_points       #return net, end_points
